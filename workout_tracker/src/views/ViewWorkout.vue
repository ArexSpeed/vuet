<template>
  <div class="max-w-screen-sm px-4 py-10 mx-auto">
    ...
    <div
      ...
      class="p-4 mb-10 rounded-md shadow-md bg-light-grey"
    >
    ...
    <div v-if="dataLoaded">
      ...
      <!-- Exercises -->
      <div
        class="flex flex-col p-8 mt-10 rounded-md shadow-md item-center bg-light-grey"
      >
        <!-- Strength Training -->
        <div v-if="data.workoutType === 'strength'" class="flex flex-col w-full gap-y-4">
          ...
          <button
            ...
            @click="addExercise"
            type="button"
            class="self-start px-6 py-2 text-sm text-white duration-200 border-2 border-transparent border-solid rounded-sm bg-at-light-green hover:border-at-light-green hover:bg-white hover:text-at-light-green"
          >
            Add Exercise
          </button>
        </div>
